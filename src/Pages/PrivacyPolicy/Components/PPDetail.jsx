...
const PPDetail = () => {
  return (
    <div className="tc-detail pp-detail">
        <div className="tc-detail-header">Privacy Policy of Myrecharge.ng</div>
        <div className='pp-detail-header'>Owner and Data Controller</div>
        <div className='pp-myr'>MyRecharge Incorporated 2020.</div>
        <div className='pp-contact'>Owner contact email: support@myrecharge.ng</div>

        <div className='pp-detail-header'>Types of Data collected</div>
        <div className='pp-content'>
            <p>Among the types of Personal Data that this Application collects, by itself or through third parties, there are: first name; last name; gender; date of birth; phone number; address; country; state; email address; city; User ID; Cookies; Usage Data; profession; <br /> ZIP/Postal code; website; username.</p>
        ...
        <div className='pp-detail-header'>Mode and place of processing the Data</div>
        <div className='pp-detail-header pp-detail-header-extra'>Methods of processing</div>
        <div className='pp-content'>
        ...
        <div className='pp-detail-header'>Legal basis of processing</div>
        <div className='pp-content'>
            <p>The Owner may process Personal Data relating to Users if one of the following applies:</p>
            <ul>
                <li>Users have given their consent for one or more specific purposes. Note: Under some legislations the Owner may be allowed to process Personal Data until the</li>
                <li>User objects to such processing (“opt-out”), without having to rely on consent or any other of the following legal bases. This, however, does not apply, whenever the processing of Personal Data is subject to European data protection law;</li>
                <li>provision of Data is necessary for the performance of an agreement with the User and/or for any pre-contractual obligations thereof; processing is necessary for compliance with a legal obligation to which the Owner is subject;</li>
                <li>processing is related to a task that is carried out in the public interest or in the exercise of official authority vested in the Owner; processing is necessary for the purposes of the legitimate interests pursued by the Owner or by a third party.</li>
            </ul>
            <p>In any case, the Owner will gladly help to clarify the specific legal basis that applies to the processing, and in particular whether the provision of Personal Data is a statutory or contractual requirement, or a requirement necessary to enter into a contract.</p>
        </div>

        <div className='pp-detail-header'>Place</div>
        <div className='pp-content'>
        ...
        <div className='pp-detail-header'>Retention time</div>
        <div className='pp-content'>
        ...
        <div className='pp-detail-header'>Further information about Personal Data</div>
        <div className='pp-content'>
            <ul>
        ...
        <div className='pp-detail-header'>The rights of Users</div>
        <div className='pp-content'>
        ...
        <div className='pp-detail-header'>Details about the right to object to processing</div>
        <div className='pp-content'> 
        ...
        <div className='pp-detail-header'>Additional information about Data collection and processing</div>
        <div className='pp-detail-header pp-detail-header-extra'>Legal action</div>
        <div className='pp-content'> 
        ...
        <div className='pp-detail-header'>Additional information about User’s Personal Data</div>
        <div className='pp-content'> 
            <p>In addition to the information contained in this privacy policy, this Application may provide the User with additional and contextual information concerning particular Services or the collection and processing of Personal Data upon request.</p>
        </div>

        <div className='pp-detail-header'>System logs and maintenance</div>
        <div className='pp-content'> 
        ...
        <div className='pp-detail-header'>Information not contained in this policy</div>
        <div className='pp-content'> 
            <p>More details concerning the collection or processing of Personal Data may be requested from the Owner at any time. Please see the contact information at the beginning of this document.</p>
        </div>

        <div className='pp-detail-header'>How “Do Not Track” requests are handled</div>
        <div className='pp-content'> 
        ...
        <div className='pp-detail-header'>Changes to this privacy policy</div>
        <div className='pp-content'> 
            ...
            <p>Should the changes affect processing activities performed on the basis of the User’s consent, the Owner shall collect new consent from the User, where required. Last modification by MyRecharge.ng January 2022.</p>
        </div>
    </div>
  )
}
